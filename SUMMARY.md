...
- 💻 [Java Basics](background/javabasics/java-basics.md)
  - [PartOne_Comments](javabasics/PartOne_Comments.md)
  - [PartTwo_Variables](javabasics/PartTwo_Variables.md)
  - [PartThree_Math](javabasics/PartThree_Math.md)
  - [PartFour_Methods](javabasics/PartFour_Methods.md)
  - [PartFive_Boolean Logic Operations](javabasics/PartFive_BooleanLogicOperations.md)
  - [PartSix_ComparisonOperations](javabasics/PartSix_ComparisonOperations.md)
  - [PartSeven](javabasics/PartSix_ComparisonOperations.md)
  - [PartEight_Classes](javabasics/PartFour_Methods.md)
